...
const AISummary = ({ summary, onClose }) => {
    ...
    return (
        <div className="bg-cyber-900/50 border border-cyber-700 rounded-lg p-6 shadow-lg relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <StatBox label="Accounts Checked" value={totalChecked} icon={<UserGroupIcon className="h-6 w-6" />} />
                <StatBox label="Accounts Pwned" value={totalPwned} icon={<ExclamationCircleIcon className="h-6 w-6" />} />
                <StatBox
                    label="Severity"
                    value={severity}
                    icon={<span className={getSeverityColor(severity)}><ExclamationCircleIcon className="h-6 w-6" /></span>}
                />
            </div>

            <div className="prose prose-invert max-w-none text-sm leading-relaxed text-cyber-200 [&_strong]:font-bold [&_strong]:text-cyber-100 [&_b]:font-bold [&_b]:text-cyber-100 [&_p]:mb-3 [&_ul]:mb-3 [&_ol]:mb-3 [&_li]:mb-1 [&_h3]:text-lg [&_h3]:font-bold [&_h3]:text-cyber-100 [&_h3]:mt-4 [&_h3]:mb-2 [&_table]:w-full [&_table]:table-auto [&_th]:text-left [&_td]:align-top [&_th]:border-b [&_th]:border-cyber-700 [&_td]:py-2 [&_th]:py-2 [&_a]:text-cyber-400 [&_a]:hover:underline">
