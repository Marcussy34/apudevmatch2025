import {
  initGraphQLTada
} from "./chunk-R3IVVPNV.js";
import {
  blake2b,
  bytesToHex,
  hexToBytes,
  randomBytes
} from "./chunk-PHPKF5C7.js";
import {
  __commonJS,
  __export,
  __toESM
...
// node_modules/@mysten/sui/node_modules/base-x/src/esm/index.js
...
// node_modules/@mysten/sui/node_modules/bs58/src/esm/index.js
var ALPHABET = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
var esm_default2 = esm_default(ALPHABET);

// node_modules/@mysten/sui/node_modules/@mysten/bcs/dist/esm/b58.js
var toBase58 = (buffer) => esm_default2.encode(buffer);
var fromBase58 = (str) => esm_default2.decode(str);

// node_modules/@mysten/sui/node_modules/@mysten/bcs/dist/esm/b64.js
...
// node_modules/@mysten/sui/node_modules/@mysten/bcs/dist/esm/hex.js
...
var bcs = {
  ...
  tuple(types2, options) {
    return new BcsType({
      name: `(${types2.map((t) => t.name).join(", ")})`,
      serializedSize: (values) => {
        let total = 0;
        for (let i = 0; i < types2.length; i++) {
          const size = types2[i].serializedSize(values[i]);
          if (size == null) {
            return null;
          }
          total += size;
      ...
      validate: (value) => {
        ...
        if (value.length !== types2.length) {
          throw new TypeError(`Expected array of length ${types2.length}, found ${value.length}`);
        }
      }
    });
  },
...
// node_modules/@mysten/zklogin/dist/esm/index.js
...
function jwtToAddress2(jwt, userSalt, legacyAddress = true) {
  return jwtToAddress(jwt, userSalt, legacyAddress);
}
export {
  computeZkLoginAddress2 as computeZkLoginAddress,
  genAddressSeed,
  generateNonce,
  generateRandomness,
